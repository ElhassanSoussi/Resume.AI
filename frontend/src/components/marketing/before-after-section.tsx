...
export function BeforeAfterSection() {
  return (
    <SectionShell
      ...
      title={
        <>
          From wall of text to{" "}
          <span className="text-gradient-brand">signal-rich story</span>
        </>
      }
      subtitle="Same career — sharper narrative. ResumeForge helps you rewrite for outcomes, not duties."
    >
        ...
        <FadeIn delay={0.1}>
          <div className="card-3d relative h-full overflow-hidden p-6 sm:p-8">
            ...
            <div className="mt-8 flex items-center gap-2 text-xs font-medium text-primary">
              <span>Polished with AI assist</span>
