...
export function HeroVisual() {
  return (
    <div className="perspective-wrap relative mx-auto mt-16 max-w-lg lg:mt-0 lg:max-w-none">
      <motion.div
        className="relative h-[280px] sm:h-[320px] [transform-style:preserve-3d]"
      ...
      >
        ...
        <div
          ...
          aria-hidden
        />
        <div className="pointer-events-none absolute inset-0 [transform:translateZ(0px)_translateY(0px)] rounded-2xl border border-white/[0.12] bg-gradient-to-br from-card/85 to-card/25 shadow-[0_48px_100px_-28px_rgba(0,0,0,0.72),0_0_0_1px_oklch(1_0_0/0.04)_inset] backdrop-blur-md" />
        <motion.div
          className="absolute inset-x-6 top-6 z-[1] [transform:translateZ(24px)_translateY(-8px)] rounded-xl border border-white/[0.1] bg-background/55 p-4 shadow-[0_24px_48px_-20px_rgba(0,0,0,0.55)] backdrop-blur-sm ring-1 ring-white/[0.06]"
          whileHover={{ y: -12 }}
        ...
        <motion.div
          className="absolute inset-x-10 top-[5.25rem] z-[2] [transform:translateZ(48px)_translateY(12px)] rounded-xl border border-white/12 bg-gradient-to-b from-primary/[0.08] to-card/40 p-4 shadow-[0_28px_56px_-18px_rgba(0,0,0,0.65),0_0_0_1px_oklch(0.72_0.2_255/0.18),0_0_48px_-12px_oklch(0.55_0.18_255/0.35)] backdrop-blur-md ring-1 ring-primary/25"
