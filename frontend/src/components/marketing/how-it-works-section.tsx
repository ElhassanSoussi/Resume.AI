...
export function HowItWorksSection() {
  return (
    <SectionShell
      id="how-it-works"
      eyebrow="Flow"
      title="How ResumeForge works"
      subtitle="A focused loop — write, refine, present — without losing your voice."
    ...
    >
      ...
      <FadeIn className="mt-12 text-center" delay={0.15}>
        <p className="text-sm text-muted-foreground">
          Average first export: under 15 minutes when you start from an existing resume.
        </p>
      </FadeIn>
    </SectionShell>
  );
